...
import {FormGroup, FormControl, InputGroup, Glyphicon, ControlLabel, Checkbox, Button, Form} from 'react-bootstrap'
                ...
                <Form>
                    ...
                    <InputGroup className="pdn10">
                        ...
                        <div className="div__ctrl">
                            ...
                            <div className="pdn10-right"><Button bsStyle="info" id="btn__login" type="button" onClick={this.globalValidation}>Submit</Button></div>
                        </div>
                </Form>
            </div>
        </section>
